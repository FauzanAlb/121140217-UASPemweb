...
<div class="col-lg-12">
	<div class="row edit_profile">
			...
			<div class="col-lg-6">
				...
				<p class="p_class">
					<p>Tanggal Lahir &nbsp; &nbsp; : <?= $_SESSION['tgl_lahir']?> <br></p> 
					<p>Nomor Telpon &nbsp; : <?= $_SESSION['telp']?> <br></p> 
					<p>Jenis Kelamin &nbsp; &nbsp; : <?= $_SESSION['jk']?> <br></p> 
					<p>Alamat &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : <?= $_SESSION['alamat']?> <br></p> 
				</p><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	          ...
	          <div class="form-group">
	            ...
	            <input type="date" class="form-control" id="recipient-name" name="tgl_lahir" value="<?= $_SESSION['tgl_lahir'] ?>" required>
	          </div>
			  ...
			  <div class="form-group">
    			<label for="recipient-name" class="col-form-label">Alamat:</label>
   				 <textarea class="form-control" id="recipient-name" name="alamat"><?= $_SESSION['alamat'] ?></textarea>
				</div>
